const HomePage = () => {
  return (
    <div className="relative bg-grey-100 py-16 w-full">
        ...
        <div className="lg:grid lg:grid-cols-12">
          <div className="relative z-10 lg:col-span-4 lg:col-start-1 lg:row-start-1 lg:bg-transparent lg:py-16">
            <div
              ...
              aria-hidden="true"
            />
            <div className="mx-auto  px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:p-0">
          ...
          <div className="relative bg-indigo-600 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
            ...
            <div className="relative mx-auto max-w-md space-y-6 py-12 px-4 sm:max-w-3xl sm:py-16 sm:px-6 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
              <h2
                ...
                id="join-heading"
              >
                Bienvenue sur MuzBox!
              </h2>
              <p className="text-lg text-white">
                Vous souhaitez organiser une soirée ou tout le monde apprecie la
                musique?
              </p>
              <a
              ...
              <a
                className="sm:ml-4 block w-full rounded-md border border-transparent bg-white py-3 px-5 text-center text-base font-medium text-indigo-700 shadow-md hover:bg-gray-50 sm:inline-block sm:w-auto"
                href="#/qrcodescanner"
              >
                Rejoindre une MuzBox
              </a>
            </div>
          </div>
        </div>
